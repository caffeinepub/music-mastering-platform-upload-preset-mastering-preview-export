...
import type { MasteringProject as _MasteringProject, ProjectStatus as _ProjectStatus, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async updateProjectStatus(arg0: string, arg1: ProjectStatus): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateProjectStatus(arg0, to_candid_ProjectStatus_n12(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_MasteringProject_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _MasteringProject): MasteringProject {
...
function from_candid_opt_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_MasteringProject]): MasteringProject | null {
    return value.length === 0 ? null : from_candid_MasteringProject_n4(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_vec_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_MasteringProject>): Array<MasteringProject> {
    return value.map((x)=>from_candid_MasteringProject_n4(_uploadFile, _downloadFile, x));
}
