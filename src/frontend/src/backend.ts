...
export class Backend implements backendInterface {
    ...
    async getAllProjects(): Promise<Array<MasteringProject>> {
        if (this.processError) {
            try {
    ...
    async getProject(arg0: string): Promise<MasteringProject | null> {
        if (this.processError) {
            try {
    ...
    async updateProjectStatus(arg0: string, arg1: ProjectStatus): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateProjectStatus(arg0, to_candid_ProjectStatus_n21(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadFinalMaster(arg0: string, arg1: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadFinalMaster(arg0, await to_candid_ExternalBlob_n23(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadTrack(arg0: string, arg1: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadTrack(arg0, await to_candid_ExternalBlob_n23(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_MasteringProject_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _MasteringProject): Promise<MasteringProject> {
...
async function from_candid_opt_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_MasteringProject]): Promise<MasteringProject | null> {
    return value.length === 0 ? null : await from_candid_MasteringProject_n11(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    trackBlob: [] | [_ExternalBlob];
    trackName: string;
    owner: Principal;
    createdAt: bigint;
    preset: string;
    finalMasterBlob: [] | [_ExternalBlob];
}): Promise<{
    id: string;
    status: ProjectStatus;
    trackBlob?: ExternalBlob;
    ...
    return {
        ...
        trackBlob: record_opt_to_undefined(await from_candid_opt_n15(_uploadFile, _downloadFile, value.trackBlob)),
        trackName: value.trackName,
        owner: value.owner,
        createdAt: value.createdAt,
        preset: value.preset,
        finalMasterBlob: record_opt_to_undefined(await from_candid_opt_n15(_uploadFile, _downloadFile, value.finalMasterBlob))
    };
}
...
function from_candid_variant_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "pending" in value ? ProjectStatus.pending : "complete" in value ? ProjectStatus.complete : "processing" in value ? ProjectStatus.processing : "failed" in value ? ProjectStatus.failed : value;
}
...
async function from_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_MasteringProject>): Promise<Array<MasteringProject>> {
    return await Promise.all(value.map(async (x)=>await from_candid_MasteringProject_n11(_uploadFile, _downloadFile, x)));
}
